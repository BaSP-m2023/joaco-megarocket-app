    ...
    <div className={styles.container}>
      <Suspense fallback={<Spinner />}>
        <Switch>
          ...
          <Route exact path="/superAdmin/admin/form/:id" component={AdminForm} />

          <Route exact path="/admins/activities" component={Activities} />
          <Route exact path="/admins/activities/form" component={FormActivities} />
          <Route exact path="/admins/activities/form/:id" component={FormActivities} />
          ...
          <Route exact path="/admins/classes/form/:id" component={FormClasses} />

          <Route exact path="/admins/members" component={Member} />
          <Route exact path="/admins/members/form" component={FormMembers} />
          <Route exact path="/admins/members/form/:id" component={FormMembers} />
